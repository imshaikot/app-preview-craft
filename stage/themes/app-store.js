...
export default {
  ...
  mixtape: {
    ...
    inspiredBy: 'Spotify, Apple Music — album-art glow, near-black, outlined giant type',
    blurb: 'After dark. Your own screen, blurred into a glowing backdrop, behind a giant outlined word and a black phone.',
    layout: 'big-type',
    palette: { bg: '#07070a', bg2: '#16161d', bg3: '#2a2a35', ink: '#ffffff', sub: 'rgba(255,255,255,0.7)', accent: '#c6ff4a', accent2: '#4af0ff', surface: 'rgba(255,255,255,0.08)' },
    type: { display: 'syne', body: 'space-grotesk', weight: 800, tracking: -0.04, leading: 0.98, size: 1.05, highlight: 'gradient' },
    text: { position: 'bottom' },
    bigType: { size: 0.36, y: 0.05, opacity: 0.85 },
    background: { kind: 'blur-shot', blur: 90, dim: 0.5, saturate: 1.8, grain: 0.09, vignette: 0.5 },
    device: { model: 'iphone-17-pro', y: 0.47, size: 0.62, pose: [0, -14, 0], finish: '#1b1b1f', glare: 0.8 },
    screen: { cleanStatusBar: true },
    scene: { exposure: 1.1, rims: [{ color: '#c6ff4a', intensity: 2.5, dir: [1, 0.4, -0.5] }, { color: '#4af0ff', intensity: 2, dir: [-1, 0.1, -0.5] }], wall: { depth: 0.1, opacity: 0.5 } },
    decor: [],
  },
  ...
  arcade: {
    ...
    name: 'Arcade',
    appCategory: 'Games',
    inspiredBy: 'Apple Arcade and mobile game launch art — synthwave grids, neon rims, toy-like 3D shapes',
    blurb: 'Neon playground. Synthwave sun and moving grid, outlined highlights and glossy 3D toys around a neon-lit phone.',
    layout: 'hero-top',
    ...
    scene: {
      exposure: 1.05,
      rims: [
        { color: '#ff2fb2', intensity: 4, dir: [1, 0.3, -0.5] },
        { color: '#28e7ff', intensity: 3.5, dir: [-1, 0.2, -0.4] },
      ],
      wall: { depth: 0.1, opacity: 0.4 },
    },
    decor: [
      { kind: 'shapes', count: 4, shapes: ['knot', 'cube', 'ring', 'orb'], colors: ['#ffe23f', '#28e7ff', '#ff2fb2'], size: 0.13, seed: 12 },
      { kind: 'sparkles', count: 8, colors: ['#ffe23f', '#ffffff'], area: [0, 0.2, 1, 0.6] },
    ],
  },
  ...
  snapshot: {
    id: 'snapshot',
    name: 'Snapshot',
    appCategory: 'Photo & Social',
    inspiredBy: 'Instagram, BeReal, VSCO — warm film tones, gradient words, a fanned stack of shots',
    blurb: 'Share-worthy. Three frameless screens fanned like prints, warm film mesh and a sunset-gradient highlight.',
    layout: 'fan',
    palette: { bg: '#fff5ec', bg2: '#ffd6d6', bg3: '#ffe7b8', ink: '#141414', sub: 'rgba(20,20,20,0.66)', accent: '#ff2e63', accent2: '#ff9a3c', surface: '#ffffff' },
    type: { display: 'outfit', body: 'outfit', weight: 700, bodyWeight: 450, tracking: -0.04, leading: 1, size: 1.12, highlight: 'gradient' },
    background: { kind: 'mesh', pattern: 'dots', patternColor: '#ff2e63', patternOpacity: 0.08, grain: 0.07, seed: 21 },
    device: { mode: 'frameless', y: 0.66, size: 0.58, corner: 0.075, shadow: 0.22, border: 'calc(var(--w) * .025) solid #ffffff', spread: 0.26, fanAngle: 9 },
    decor: [],
  },
  ...
  pulse: {
    id: 'pulse',
    name: 'Pulse',
    appCategory: 'Health data & Wearables',
    inspiredBy: 'Oura, WHOOP, Apple Health — clinical black, vital-sign reds, glass cards',
    blurb: 'Data you can feel. Deep black, a crimson glow, glass surfaces and a front-facing Pro Max with sharp rim light.',
    layout: 'hero-bottom',
    palette: { bg: '#050507', bg2: '#2a0710', bg3: '#5a0f1f', ink: '#ffffff', sub: 'rgba(255,255,255,0.66)', accent: '#ff375f', accent2: '#ff9f0a', surface: 'rgba(255,255,255,0.06)' },
    type: { display: 'manrope', body: 'manrope', weight: 700, tracking: -0.045, leading: 1.02, size: 1.05, highlight: 'color' },
    background: { kind: 'radial', cx: 50, cy: 38, grain: 0.05, vignette: 0.4, pattern: 'topo', patternColor: '#ff375f', patternOpacity: 0.07, patternScale: 1.4 },
    device: { model: 'iphone-17-pro-max', y: 0.4, size: 0.72, pose: [0, 0, 0], finish: '#1d1d22', glare: 0.5 },
    screen: { cleanStatusBar: true },
    scene: { rims: [{ color: '#ff375f', intensity: 4, dir: [0.9, 0.5, -0.6] }, { color: '#ff9f0a', intensity: 1.5, dir: [-0.9, -0.3, -0.6] }], wall: { depth: 0.08, opacity: 0.5 } },
    decor: [],
  },
}
